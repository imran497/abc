  ...
  render(){
    ...
    return(
      <Modal isOpen={showEmailOverlay} toggle={hideEmailOverlay}  size="lg">
       ...
       <ModalBody>
       <button className="btn btn-info m-2" onClick={() => this.setState({ showing:!showing })}>Hide Header</button>
       ...
       <thead>
        ...
        <td className="th_data">{this.state.actualFields['sdate']}</td>
        </tr>
        <tr>
        <th className="th_header" scope="row">From</th>
        <td className="th_data">{this.state.actualFields['from']}</td>
        </tr>
        <tr>
        <th className="th_header" scope="row">To</th>
        <td className="th_data">{this.state.actualFields['to']}</td>
        </tr>
        <tr>
        ...
        <td className="th_data">{this.state.actualFields['subject']}</td>
        </tr>
        { (!showing) ?
        <tr>
